  ...
  return (
    <div className='compBackground pageWhtTxt' style={{ width: '100%', borderRadius: '10px' }}>
      ...
      <div style={{ borderTop: '1px solid gray' }} className='d-flex justify-content-between p-3 mt-2'>
        <div className='d-flex align-items-center'><i class="bi bi-hand-thumbs-up iconPost"></i><span className='fw-bold ms-2'>Consiglia</span></div>
        <div className='d-flex align-items-center'><i class="bi bi-chat-text iconPost"></i><span className='fw-bold ms-2'>Commenta</span></div>
        <div className='d-flex align-items-center'><i class="bi bi-arrow-repeat iconPost"></i><span className='fw-bold ms-2'>Diffondi il post</span></div>
        <div className='d-flex align-items-center'><i class="bi bi-send-fill iconPost"></i><span className='fw-bold ms-2'>Invia</span></div>
      </div>
    </div>
  )
}
