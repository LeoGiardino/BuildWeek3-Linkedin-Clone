    ...
    <>
      <Card>
        <div className="imgsContainer mb-3">
          ...
          />
          <img
            className="imgPropicHome"
            src="https://epicode-testapi-bucket.s3.eu-south-1.amazonaws.com/1706620634516-_9e8fc6e0-4b63-4fa7-ae64-a6792b717646.jpeg"
          />
        </div>
        <Card.Body className="px-0 pb-0">
          <Card.Title className="text-center">Leos Giardino</Card.Title>
          <div className="descrizioneProfilo">Full Stack Developer</div>
          ...
          <div className="premiumProfilo">
            ...
            <div className="d-flex align-items-center">
              <div className="premiumIcon me-2 mb-1"></div>
              <div className="pageWhtTxt">Prova Premium per 0 EUR</div>
            </div>
          </div>
