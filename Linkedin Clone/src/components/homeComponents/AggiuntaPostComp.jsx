      ...
      <Card>
        <Card.Body className="pb-0">
          <div className="d-flex align-items-center justify-content-between avvioPost">
            <img
              className="rounded-circle me-2 propicHomeC"
            ...
            />
            <button
              className="w-100 nostroBtnHome fw-bold"
              onClick={handleShow}
            >
              Avvia un post
            </button>
            ...
            <div className="d-flex align-items-center headerModale">
              ...
              <div className="d-flex flex-column profiloModalePost">
                <span className="fw-bold">
                  Nome utente <CaretDownFill className="iconcine" />
                </span>
