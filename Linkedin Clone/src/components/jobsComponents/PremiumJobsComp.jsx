                    ...
                    <div className='d-flex justify-content-between align-items-start consigliatiGroup w-100'>
                        ...
                        <div className='d-flex flex-column w-100'>
                            ...
                            <span className='periodoFormazione secondoSottotitolo d-flex align-items-center'>
                                <div className='mb-1 tantiProfili'><img className='rounded-circle tantiProfili1' src='https://media.licdn.com/media/AAUQAgE2AAgAAQAAAAAAAAhCAAAAJDBmNzFjMzUzLWFlNTAtNDRkZi1hNmZlLTljNjI0MzRlMmY4YQ.png' /><img className='rounded-circle tantiProfil2' src='https://media.licdn.com/media/AAUQAgE2AAgAAQAAAAAAAAdKAAAAJDQ1YjQ5MTk5LTY2ZGUtNDI2MC05YmQ1LTE3YjE4ZWNlN2ZkYg.png' /><img className='rounded-circle tantiProfili3' src='https://media.licdn.com/media/AAUQAgE2AAgAAQAAAAAAAAHzAAAAJGJiZDM1MGJkLTIzOTAtNDhmMS1hZTM5LTEzZDk2NWQ4ZDhjYQ.png' /></div>
