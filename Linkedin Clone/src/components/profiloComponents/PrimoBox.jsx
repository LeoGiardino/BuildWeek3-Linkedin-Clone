            ...
            <>
              <div className="informazioni pt-5">
                <h4 className="pageWhtTxt mb-1 d-flex align-items-center">
                  ...
                  <span className="pageWhtTxt me-2">
                    {state.profili.surname}
                  </span>
                ...
                <p className="pageGrayTxt mb-2 fsize-small">
                  ...
                  <span>
                    <a
                      href=""
                      style={{ color: "#6ABAFB", textDecoration: "none" }}
                    >
              ...
              <div className=" rightSide d-none d-lg-block">
                <div className="d-flex align-items-center pt-5">
                  <img
                    src="https://media.licdn.com/dms/image/C560BAQGKHWgSsI9ZVg/company-logo_100_100/0/1631368771194?e=1715212800&v=beta&t=AEsUPaWtiat02K_jAbHKOP3rdaHH-_S1F92qKoRI1o4"
                    alt="ifoa"
                    style={{ width: "30px" }}
                  />
                  <span
                    className="ms-2 pageWhtTxt"
                    style={{ fontSize: "12px" }}
                  >
      ...
      {form && (
        ...
        >
          ...
          <Modal.Body>
            ...
            <Button className="float-end" onClick={handleSaveButtonClick}>
              Salva
            </Button>
          </Modal.Body>
        </Modal>
